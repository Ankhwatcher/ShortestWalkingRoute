...
public class DisplayRoutesActivity extends ActionBarActivity {
    ...
    protected void drawRoute(GoogleMap googleMap, int routeNo, int routeColor, Boolean isChecked) {
        routeNo++;
    ...
    public class routeMultiChoiceListener implements
        ...
        public void onClick(DialogInterface dialog, int which, boolean isChecked) {
            ...
            GoogleMap currentMap = ((SupportMapFragment) getSupportFragmentManager().findFragmentById(R.id.route_map)).getMap();
